...
public class PacketNpcSwingEvent extends PacketBase
{
    public static final String channel = Utility.swingEventChannelName;
    
    public PacketNpcSwingEvent()
    {
        super(PacketNpcSwingEvent.channel);
    }
    
    public PacketNpcSwingEvent(Packet250CustomPayload packet)
    {
        super(PacketNpcSwingEvent.channel, packet);
    }
    ...
    public void readResponseParameter(DataInputStream dis, World world, EntityNpc npc) throws IOException
    {
        if ( npc == null )
        {
            Utility.printWarning("npc == null @ PacketNpcSwingEvent.readResponseParameter");
            return;
        }
